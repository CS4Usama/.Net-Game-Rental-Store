...
namespace GameRentalStore.DataAccess.Migrations
{
    ...
    [Migration("20240706205319_ShoppingCartTableDetails")]
    partial class ShoppingCartTableDetails
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("GameRentalStore.Models.ShoppingCart", b =>
                {
                    ...
                    b.Property<int>("TotalSubscriptionMonth")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("GameRentalStore.Models.SubscriptionPackage", b =>
                {
                    ...
                    b.Property<int>("RentGame")
                        .HasColumnType("int");

                    b.Property<int>("RentNewReleasedGame")
                        .HasColumnType("int");

                    b.Property<int>("ReplaceGame")
                        .HasColumnType("int");
